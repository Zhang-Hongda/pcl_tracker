...
public:
  ...
  {
    color_cond->addComparison (pcl::PackedRGBComparison<RefPointType>::Ptr (new pcl::PackedRGBComparison<RefPointType> ("r", pcl::ComparisonOps::LT, rMax))); 
    color_cond->addComparison (pcl::PackedRGBComparison<RefPointType>::Ptr (new pcl::PackedRGBComparison<RefPointType> ("r", pcl::ComparisonOps::GT, rMin))); 
    color_cond->addComparison (pcl::PackedRGBComparison<RefPointType>::Ptr (new pcl::PackedRGBComparison<RefPointType> ("g", pcl::ComparisonOps::LT, gMax))); 
    color_cond->addComparison (pcl::PackedRGBComparison<RefPointType>::Ptr (new pcl::PackedRGBComparison<RefPointType> ("g", pcl::ComparisonOps::GT, gMin))); 
    color_cond->addComparison (pcl::PackedRGBComparison<RefPointType>::Ptr (new pcl::PackedRGBComparison<RefPointType> ("b", pcl::ComparisonOps::LT, bMax))); 
    color_cond->addComparison (pcl::PackedRGBComparison<RefPointType>::Ptr (new pcl::PackedRGBComparison<RefPointType> ("b", pcl::ComparisonOps::GT, bMin))); 
  }
